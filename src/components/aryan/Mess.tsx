    ...
    <section ref={root} id="mess" className="py-16 md:py-24 border-t border-hairline relative bg-background">
      <div className="max-w-[1700px] mx-auto px-5 md:px-8 grid md:grid-cols-12 gap-12 md:gap-20">
        ...
        <div data-mess-img className="md:col-span-5 h-[50vh] md:h-[85vh] overflow-hidden rounded-3xl surface sticky top-8 cursor-pointer group"
          ...
          <img src={mess} alt="Mess hall" className="w-full h-full object-cover brightness-[1.25] contrast-[1.15] saturate-[1.1] transition-all duration-700 group-hover:scale-105" loading="lazy" />
