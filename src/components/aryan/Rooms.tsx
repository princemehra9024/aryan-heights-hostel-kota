...
export const Rooms = () => {
  ...
  return (
    <section
      ref={root}
      id="rooms"
      className="py-16 md:py-24 border-t border-hairline bg-background overflow-hidden"
    >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-10 mb-12 md:mb-24">
          <div>
            ...
            <div className="overflow-hidden">
              <h2 className="rh-line font-display text-[11vw] sm:text-6xl md:text-8xl leading-[0.95] md:leading-[0.92] tracking-tighter">
                Pick the room.
              </h2>
            </div>
            <div className="overflow-hidden">
              <h2 className="rh-line font-display text-[11vw] sm:text-6xl md:text-8xl leading-[0.95] md:leading-[0.92] tracking-tighter text-maroon italic">
                We handle the rest.
              </h2>
            </div>
          </div>
