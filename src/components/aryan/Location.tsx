    ...
    <section ref={root} className="py-28 md:py-40 border-t border-hairline">
      <div className="max-w-[1700px] mx-auto px-5 md:px-8 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-4">
          ...
          <h2 data-loc className="font-display text-5xl md:text-6xl leading-[1.02] tracking-tighter">3 minutes<br/>from Allen.</h2>
          <p data-loc className="text-foreground/70 mt-6 max-w-md">In the heart of Talwandi — surrounded by Allen, Resonance, Vibrant, and every coaching that matters in Kota.</p>
          <ul data-loc className="mt-8 space-y-3 text-sm">
            {[["Allen Campus","3 min walk"],["Resonance","6 min walk"],["Vibrant Academy","8 min walk"],["Kota Junction","12 min drive"]].map(([n,t]) => (
        ...
        <div data-loc className="md:col-span-8 aspect-[16/10] overflow-hidden surface relative">
          <iframe
            ...
            src="https://www.google.com/maps?q=Talwandi%20Kota%20Rajasthan&output=embed"
